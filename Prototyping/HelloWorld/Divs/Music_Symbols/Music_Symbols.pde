...
//
float CloseButtonDivWidth = DivWidth/24;
float CloseButtonDivHeight = DivHeight/18;
float CloseButtonDivX = width - CloseButtonDivWidth; 
float CloseButtonDivY = 0; 
;rect( CloseButtonDivX, CloseButtonDivY,CloseButtonDivWidth, CloseButtonDivHeight );
line(CloseButtonDivX, CloseButtonDivY,  CloseButtonDivX + CloseButtonDivWidth, CloseButtonDivY + CloseButtonDivHeight);
line(CloseButtonDivX + CloseButtonDivWidth, CloseButtonDivY,CloseButtonDivX, CloseButtonDivY + CloseButtonDivHeight);
//
float DoubleSpeedoffDivWidth = DivWidth/12;
float DoubleSpeedoffDivX = DivX + DivWidth*0.757;
float DoubleSpeedoffDivY = DivY + DivHeight*0.92;
float DoubleSpeedoffDivHeight = DivHeight/9;
;rect( DoubleSpeedoffDivX, DoubleSpeedoffDivY,DoubleSpeedoffDivWidth, DoubleSpeedoffDivHeight );
fill(0);
line(DoubleSpeedoffDivX, DoubleSpeedoffDivY,  DoubleSpeedoffDivX + DoubleSpeedoffDivWidth, DoubleSpeedoffDivY + DoubleSpeedoffDivHeight);
line(DoubleSpeedoffDivX + DoubleSpeedoffDivWidth, DoubleSpeedoffDivY,DoubleSpeedoffDivX, DoubleSpeedoffDivY + DoubleSpeedoffDivHeight); 
textSize(DoubleSpeedoffDivHeight * 0.8); 
textAlign(CENTER, CENTER);
text("2", DoubleSpeedoffDivX + DoubleSpeedoffDivWidth/2,DoubleSpeedoffDivY + DoubleSpeedoffDivHeight/2);
//
